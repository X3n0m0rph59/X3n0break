...
public class BackgroundFactory {
	...
	public static Background getRandomBackground() {
		...
		{
		case 0:
			sprite = new SpriteObject("data/backgrounds/00.png", 256, 256, 256, 256, true);
			break;
			
		case 1:				
			sprite = new SpriteObject("data/backgrounds/01.png", 256, 256, 256, 256, true);
			break;
			
		case 2:
			sprite = new SpriteObject("data/backgrounds/02.png", 256, 256, 256, 256, true);
			break;
			
		case 3:
			sprite = new SpriteObject("data/backgrounds/03.png", 256, 256, 256, 256, true);
			break;
			
		case 4:
			sprite = new SpriteObject("data/backgrounds/04.png", 256, 256, 256, 256, true);
			break;
